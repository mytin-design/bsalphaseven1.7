<?php
// List all available completed assignments uploaded by a students
//Incomplete - Make sure that a teacher sees assignments that they uploaded;
...
$sql = "SELECT * FROM staffcompletedassigns ORDER BY dateuploaded ASC";
