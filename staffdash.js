//For staffdashboard side nav panel

let openStaffer = () => {
    document.getElementById("staffsideNav").style.width = "14pc";
}

let closeStaffer = () => {
    document.getElementById("staffsideNav").style.width = "0";
}
...
function openstregSubj(event, regstf) {
    //declare variables
    ...
    document.getElementById(regstf).style.display = "block";

    event.currentTarget.classList.add("active");
}

//display the tab whose button's ID is specified 
document.getElementById("regstaffsubjbtnmain").click();
